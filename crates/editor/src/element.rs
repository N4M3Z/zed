...
impl EditorElement {
    ...
    fn register_actions(&self, window: &mut Window, cx: &mut App) {
        ...
        register_action(editor, window, Editor::insert_review_annotation);
        register_action(editor, window, Editor::go_to_next_review_annotation);
        register_action(editor, window, Editor::go_to_previous_review_annotation);
        register_action(editor, window, Editor::delete_review_annotation);
